...
def get_coordinate(record):
    ...
    """
    for treasure, coordinate in enumerate(record):
        extracted_coordinate = str(coordinate)
...
def convert_coordinate(coordinate):
    ...
    """
    split_coordinate = (coordinate[0], coordinate[1])
...
def compare_records(azara_record, rui_record):
    ...
    """
    comparison_result = azara_record[1] == rui_record[1][0] + rui_record[1][1]
...
def create_record(azara_record, rui_record):
    ...
    coordinate_two = rui_record[1][0] + rui_record[1][1]
    
    if coordinate_one == coordinate_two:
        match = azara_record + rui_record
        return match
    else:
        negative_result = "not a match"
...
def clean_up(combined_record_group):
    ...
    for item in combined_record_group:
        ...
        clean_report_formatted.append(str(clean_report))
        
    return "\n".join(clean_report_formatted) + "\n"
